...
class SomProjectsAirport extends Model
{
     ...
     */
    public static $rules = [
        'name' => 'nullable|string|max:245',
        'address' => 'nullable|string|max:245',
        'city' => 'nullable|string|max:45',
        'country' => 'nullable|string|max:45',
        'lat' => 'nullable|numeric',
        'long' => 'nullable|numeric',
        'iata_oaci' => 'nullable|string|max:45',
        'som_projects_airport_type_id' => 'nullable|integer',
        'size' => 'nullable|numeric',
        'revenues_aeronautical' => 'nullable|numeric',
        'revenues_non_aeronautical' => 'nullable|numeric',
        'total_revenues' => 'nullable|numeric',
        'total_opex' => 'nullable|numeric',
        'ebitda' => 'nullable|numeric',
        'kpi_revenues_aeronautical' => 'nullable|numeric',
        'kpi_revenues_non_aeronautical' => 'nullable|numeric',
        'kpi_ebitda' => 'nullable|numeric',
        'percentage_international' => 'nullable|numeric',
        'percentage_transfer' => 'nullable|numeric',
        'percentage_non_low_cost' => 'nullable|numeric',
        ...
        'top1_airline_percentage' => 'nullable|numeric',
        'top2_airline_percentage' => 'nullable|numeric',
        'top3_airline_percentage' => 'nullable|numeric',
