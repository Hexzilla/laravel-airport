...
return [
    ...
    'denied_privilege' => 'Sorry you do not have privilege to perform this operation !',
    ...
    'text_form'                => 'Form',
     ...
     //error Transaction CRUD
     'alert_delete_data_error' => 'An error occured trying to delete the selected data!',
     'alert_add_data_error' => 'An error occured while trying to add new data!',
     'alert_update_data_error' => 'An error occured while trying to update the information!',

    //MAILING
	'email_task_notification_subject' => 'Support request on ##project_name##',
    'email_approval_notification_subject' => 'Approval request on ##project_name##',
    'email_milestone_notification_subject' => 'Deadline approaching for ##project_name##',
    'email_consulted_notification_subject' => '##appname## – Consulta Tarea ##task_name##',
    
    'email_notification_fail' => 'Notification failed',
    'email_approval_no_data' => 'No data found for approval notification'
