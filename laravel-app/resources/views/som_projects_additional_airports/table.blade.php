<div class="table-responsive" style="padding: 10px;">
    <table class="table table-bordered data-table" id="somProjectsAdditionalAirports-table">
        <thead>
            <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="deleteModalBody">
                <div>
                    {!! Form::open(['route' => ['somProjectsAdditionalAirports.destroy', '0'], 'id'=>'delete_form', 'method' => 'delete']) !!}
...
function openDeleteModal(id){
    $("#delete_form").attr("action","/somProjectsAdditionalAirports/"+id);
...
$(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: false,
        serverSide: false,
        ajax: "{{ route('somProjectsAdditionalAirports.index', ['project_id'=>$projectId]) }}",
        ...
        columns: [
            ...
            {data: 'som_projects_airport_name', name: 'som_projects_airport_name', orderable: true, searchable: true},           
...
function deleteSelectedRow(){
    ...
    {  
        ...
        if(check == true){
            ...
            $.ajax({
                url: '{{ url('somProjectsAdditionalAirportsDeleteAll') }}',
                type: 'DELETE',
