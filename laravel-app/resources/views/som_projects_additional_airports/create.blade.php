...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-plane-departure"></i> Add Additional Airports</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::open(['route' => 'somProjectsAdditionalAirports.store']) !!}

            <div class="card-header coh">
                <span><i class="fas fa-plane-departure ml-2"></i> Add Additional Airports</span>
            </div>
