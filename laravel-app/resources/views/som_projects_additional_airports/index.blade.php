    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12 text-right">
                ...
                <i class="fa fa-angle-right" style="color: blue;"></i>  <a href="javascript:void(0)">Additional Airports</a>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h5><i class="fas fa-plane-departure"></i> Additional Airports</h5>
            </div>
            <div class="col-sm-6 text-right">
                <a class="btn btn-primary float-right"
                       href="{{ route('somProjectsAdditionalAirports.create') }}">
