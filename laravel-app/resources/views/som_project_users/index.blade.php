            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-12 text-right">
                        ...
                        <i class="fa fa-angle-right" style="color: blue;"></i>  <a href="{{url('somProjects')}}">Projects</a>
                        <i class="fa fa-angle-right" style="color: blue;"></i> Som Project Users
                    </div>
                    <a class="btn btn-primary float-right"
                       href="{{ route('somProjectUsers.create') }}">
                        Add New
                    </a>
                </div>
            </div>
