<div class="table-responsive" style="padding: 10px;">
    <table class="table table-bordered data-table" id="cmsDashboards-table">
        <thead>
            <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="deleteModalBody">
                <div>
                    {!! Form::open(['route' => ['cmsDashboards.destroy', '0'], 'id'=>'delete_form', 'method' => 'delete']) !!}
...
function openDeleteModal(id){
    $("#delete_form").attr("action","/cmsDashboards/"+id);
...
$(function () {     
    var table = $('.data-table').DataTable({
        processing: false,
        serverSide: false,
        ajax: "{{ route('cmsDashboards.index') }}",
...
function deleteSelectedRow(){
    ...
    {  
        ...
        if(check == true){
            ...
            $.ajax({
                url: '{{ url('cmsDashboardsDeleteAll') }}',
                type: 'DELETE',
