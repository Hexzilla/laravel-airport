...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-right">
                    ...
                    <i class="fa fa-angle-right" style="color: blue;"></i>  <a href="javascript:void(0)">Create Som Departments</a>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><i class="fa fa-folder"></i> Create Som Departments</h5>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::open(['route' => 'somDepartments.store']) !!}
