...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-globe"></i> Edit Country Info</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <div class="row">
            <div class="col-12-lg ml-4 mb-4">
                <a href="{{ route('somCountryInfos.index',['somCountry_id'=> $somCountry_id]) }}">
                    <i class="fa fa-chevron-circle-left"></i> Back To List Data Country Info
                </a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-header coh">
                <span><i class="fa fa-globe ml-2"></i> Edit Country Info</span>
            </div>
            ...
            <div class="card-footer">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <a href="{{ route('somCountryInfos.index',['somCountry_id'=> $somCountry_id]) }}" class="btn btn-back"><i class="fa fa-chevron-circle-left"></i> Back</a>
