...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('from_name', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- From Email Field -->
<div class="form-group col-sm-6">
    {!! Form::label('from_email', 'From Email:') !!}
    {!! Form::text('from_email', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Cc Email Field -->
<div class="form-group col-sm-6">
    {!! Form::label('cc_email', 'Cc Email:') !!}
    {!! Form::text('cc_email', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>
