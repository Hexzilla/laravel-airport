...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-glass-martini"></i> Edit Status Approvals</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <div class="row">
            <div class="col-12-lg ml-4 mb-4">
                <a href="{{ route('somStatusApprovals.index',['som_approvals_responsible_id'=> $som_approvals_responsible_id]) }}">
                    <i class="fa fa-chevron-circle-left"></i> Back To List Data Status Approvals
                </a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-header coh">
                <span><i class="fas fa-glass-martini ml-2"></i> Edit Status Approvals</span>
            </div>
            ...
            <div class="card-footer">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <a href="{{ route('somStatusApprovals.index',['som_approvals_responsible_id'=> $som_approvals_responsible_id]) }}" class="btn btn-back"><i class="fa fa-chevron-circle-left"></i> Back</a>
