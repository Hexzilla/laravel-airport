...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-glass-martini"></i> Edit Project Phases</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <div class="card-header coh">
                <span><i class="fas fa-glass-martini ml-2"></i> Edit Project Phases</span>
            </div>
            ...
            <div class="card-footer">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <a href="{{ route('somProjectsPhases.index', ['project_id' => $projectId]) }}" class="btn btn-back"><i class="fa fa-chevron-circle-left"></i> Back</a>
